...
object AccessWriter
{
	...
	/**
	 * Generates the "with" and "in" filtering methods for the specified class
	 * @param classToWrite Class for which properties are written
	 * @param modelPropName Name of the (database) model property
