...
object VaultReferences
{
	...
	object Vault
	{
		...
		lazy val targetingTimeline = Reference(targetMany, "TargetingTimeline")
		lazy val accessMany = Reference(targetMany, "AccessMany")
		lazy val accessManyRows = Reference(targetMany, "AccessManyRows")
	...
	object Paradigm
	{
		...
		lazy val linearVelocity = Reference(motion1D, "LinearVelocity")
