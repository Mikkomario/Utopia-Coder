...
import utopia.coder.vault.model.data.{Enum, EnumerationValue}
import utopia.coder.vault.model.datatype.StandardPropertyType
import utopia.coder.vault.model.datatype.StandardPropertyType.{EnumValue, NonEmptyText, Text}
import utopia.coder.vault.util.VaultPackages
